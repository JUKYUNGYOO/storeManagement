...
class imagebuttonTwoDetails extends StatefulWidget {
  final int id;
  final List<int>? composition;

  imagebuttonTwoDetails(this.id, this.composition);

  @override
  _imagebuttonTwoDetailsState createState() => _imagebuttonTwoDetailsState();
}

class _imagebuttonTwoDetailsState extends State<imagebuttonTwoDetails> {
  String productId = '-';
  String productName = '-';
