...
class imagebuttonFourDetails extends StatefulWidget {
  final int id;
  final List<int>? composition;

  imagebuttonFourDetails(this.id, this.composition);

  @override
  _imagebuttonFourDetailsState createState() => _imagebuttonFourDetailsState();
}

class _imagebuttonFourDetailsState extends State<imagebuttonFourDetails> {
  String productId = '-';
  String productName = '-';
