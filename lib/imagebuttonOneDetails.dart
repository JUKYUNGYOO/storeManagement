...
class imagebuttonOneDetails extends StatefulWidget {
  final int id;
  final List<int>? composition;

  imagebuttonOneDetails(this.id, this.composition);

  @override
  _imagebuttonOneDetailsState createState() => _imagebuttonOneDetailsState();
}

class _imagebuttonOneDetailsState extends State<imagebuttonOneDetails> {
  String productId = '-';
  String productName = '-';
