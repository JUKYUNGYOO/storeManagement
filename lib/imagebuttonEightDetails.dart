...
class imagebuttonEightDetails extends StatefulWidget {
  final int id;
  final List<int>? composition;

  imagebuttonEightDetails(this.id, this.composition);

  @override
  _imagebuttonEightDetailsState createState() =>
      _imagebuttonEightDetailsState();
}

class _imagebuttonEightDetailsState extends State<imagebuttonEightDetails> {
  String productId = '-';
  String productName = '-';
