...
class imagebuttonSixDetails extends StatefulWidget {
  final int id;
  final List<int>? composition;

  imagebuttonSixDetails(this.id, this.composition);

  @override
  _imagebuttonSixDetailsState createState() => _imagebuttonSixDetailsState();
}

class _imagebuttonSixDetailsState extends State<imagebuttonSixDetails> {
  String productId = '-';
  String productName = '-';
