...
class imagebuttonFiveDetails extends StatefulWidget {
  final int id;
  final List<int>? composition;

  imagebuttonFiveDetails(this.id, this.composition);

  @override
  _imagebuttonFiveDetailsState createState() => _imagebuttonFiveDetailsState();
}

class _imagebuttonFiveDetailsState extends State<imagebuttonFiveDetails> {
  String productId = '-';
  String productName = '-';
