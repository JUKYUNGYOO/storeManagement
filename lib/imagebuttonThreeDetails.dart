...
class imagebuttonThreeDetails extends StatefulWidget {
  final int id;
  final List<int>? composition;

  imagebuttonThreeDetails(this.id, this.composition);

  @override
  _imagebuttonThreeDetailsState createState() =>
      _imagebuttonThreeDetailsState();
}

class _imagebuttonThreeDetailsState extends State<imagebuttonThreeDetails> {
  String productId = '-';
  String productName = '-';
